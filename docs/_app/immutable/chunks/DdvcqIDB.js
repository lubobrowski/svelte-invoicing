...
function lr(t, n = !1) {
	...
	const r = ft(t)
	return (
		n || (r.equals = At), tt && i !== null && i.l !== null && ((e = i.l).s ?? (e.s = [])).push(r), r
	)
}
function sn(t) {
...
function ar(t, n) {
	return (
		u !== null && !y && nt() && (u.f & (g | ot)) !== 0 && (A === null || !A.includes(t)) && rn(),
		un(t, n)
	)
}
function un(t, n) {
	...
	if (r !== null)
		for (var e = nt(), a = r.length, l = 0; l < a; l++) {
			var s = r[l],
				f = s.f
			;(f & D) === 0 &&
				((!e && s === o) || (x(s, n), (f & (d | E)) !== 0 && ((f & g) !== 0 ? kt(s, C) : et(s))))
		}
}
let O = !1
function sr(t) {
...
function Ut(t) {
	...
	try {
		...
		if (nt() && w !== null && !y && v !== null && (t.f & (g | C | D)) === 0)
			for (p = 0; p < w.length; p++) Ht(w[p], t)
